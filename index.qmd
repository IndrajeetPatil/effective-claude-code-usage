...
**How** · use the `Task` tool for simple fan-out or the `Workflow` tool for deterministic orchestration with budget control. Each subagent gets an isolated context.
:::

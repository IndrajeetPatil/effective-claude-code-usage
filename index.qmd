...
- **AGENTS.md, auto memory & hooks** — durable context and enforcement
...
| **Auto** | Classifier-approved actions (still blocks risky ones) | Default on Pro/Max/Team; long tasks |
...
| `/init` | Built-in · generate AGENTS.md |
...
![](media/diag-04-context-window.webp){fig-align="center" fig-alt="Diagram showing five inputs flowing into the context window: AGENTS.md, history, files, tool outputs, images"}
...
> *"AGENTS.md is durable instruction context; auto memory is Claude's local notebook."*

## How [AGENTS.md](https://code.claude.com/docs/en/memory) Is Loaded {.smaller}

![](media/diag-05-claude-md-loading.webp){fig-align="center" fig-alt="Diagram showing how global, project-root, subdirectory AGENTS.md files and @imports merge into the system prompt"}

## AGENTS.md Anatomy {.smaller}
...
::: {.terminal-box}
<pre><code><span style="color:#38bdf8;"># My Project AGENTS.md</span>
...
Run `/init` in any repo — Claude inspects the codebase and writes a AGENTS.md for you. Edit it to add conventions and "never do" rules.
:::
...
::: {.card-green .card-compact style="font-size:0.82em;"}
**AGENTS.md** · you write durable project instructions: non-obvious commands, conventions, workflow rules, architecture decisions, and gotchas.
:::
...
<span style="color:#22c55e;">  + ~/.claude/AGENTS.md</span>
<span style="color:#22c55e;">  + ./AGENTS.md</span>
...
![](media/diag-12-workflows.webp){fig-align="center" fig-alt="Diagram showing advanced workflow orchestration coordinating subagents, parallelism, progress tracking, structured output, budget control, and reviewable results"}
...
AGENTS.md for durable instructions · `/plan` for complex tasks · Worktrees for isolation · Subagents for focused side work · Skills for repeatable actions · `/compact` when context fills · Intent + acceptance criteria · Diff + tests before acceptance
:::

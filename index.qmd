...
::: {.card-subtle .card-compact style="margin-bottom: 0.35em; font-size: 0.82em;"}
**1. Research** · Claude reads the codebase before drafting anything.
:::

::: {.card-subtle .card-compact style="margin-bottom: 0.35em; font-size: 0.82em;"}
**2. Draft** · Claude writes a plan with concrete steps.
:::

::: {.card-subtle .card-compact style="margin-bottom: 0.35em; font-size: 0.82em;"}
**3. Annotate** · you add inline corrections and questions.
:::

::: {.card-subtle .card-compact style="margin-bottom: 0.35em; font-size: 0.82em;"}
**4. Revise** · Claude incorporates feedback, updates the plan.
:::

::: {.card-subtle .card-compact style="font-size: 0.82em;"}
**5. Repeat** · iterate until confident, *then* execute.
:::
...
**Why this works** · the plan becomes a shared contract. Annotation rounds catch misunderstandings *before* code is written.
:::

::: {.card-blue .card-compact style="font-size:0.78em; margin-top: 0.4em;"}
**Pro tip** · persist the plan in `plan.md` as a living checklist. It survives `/compact` and context resets.
:::

::: {.card-amber .card-compact style="font-size:0.78em; margin-top: 0.4em;"}
**One long session > many short ones** · accumulated context makes Claude smarter with each step.
:::
...
::: {.card-blue .card-compact style="font-size:0.78em; margin-top:0.4em;"}
**Mental model** · you are the product manager, Claude is the senior engineer. Opus 4.6 already follows patterns, runs tests, and loops on failures.
:::
...
<span style="color:#8b949e;"># → .claude/worktrees/feature-auth/</span>
...
::: {.card-green .card-compact style="font-size:0.82em;"}
**Automatic cleanup** · no changes → worktree deleted automatically. Changes exist → Claude prompts: keep or discard?
:::

::: {.card-blue .card-compact style="font-size:0.78em; margin-top:0.4em;"}
**Pro tip** · add `.claude/worktrees/` to `.gitignore` — worktree dirs appear as untracked files without it.
:::

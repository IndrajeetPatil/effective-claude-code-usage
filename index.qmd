...
| **[MCP](https://docs.anthropic.com/en/docs/claude-code/mcp)** | GitHub PRs, Jira tickets, Postgres, and more |
...
## [Skills](https://docs.anthropic.com/en/docs/claude-code/slash-commands) — Reusable Playbooks {.smaller}
...
## [Slash Commands](https://docs.anthropic.com/en/docs/claude-code/interactive-mode) — Session Control {.smaller}
...
## How [CLAUDE.md](https://docs.anthropic.com/en/docs/claude-code/memory) Is Loaded {.smaller}
...
## [Hooks](https://docs.anthropic.com/en/docs/claude-code/hooks) — Automated Validation {.smaller}
...
## Dream — Memory Consolidation {.smaller}
...
Over time, [auto memory](https://docs.anthropic.com/en/docs/claude-code/memory) accumulates noise: stale facts, relative dates that lose meaning, and contradictions. **Dream** runs a reflective consolidation pass to clean this up.
:::

::: {.card-subtle .card-compact style="font-size:0.78em; margin-top:0.5em;"}
...
<span style="color:#e6edf3;">  Auto-dream:   </span><span style="color:#22c55e;">on</span>
<span style="color:#e6edf3;">  Last dream:   13h ago</span>

<span style="color:#8b949e;"># Dream consolidates memories</span>
<span style="color:#8b949e;"># between sessions, like sleep</span>
<span style="color:#8b949e;"># does for the brain:</span>
<span style="color:#8b949e;">#  - Merges duplicates</span>
<span style="color:#8b949e;">#  - Fixes stale dates</span>
<span style="color:#8b949e;">#  - Removes contradictions</span>
<span style="color:#8b949e;">#  - Prunes the index</span>
</code></pre>
:::
...
## [Subagent](https://docs.anthropic.com/en/docs/claude-code/sub-agents) Orchestration {.smaller}
...
[**Let Claude decide**]{style="font-size:0.95em;"}

- Describe **what** you want done, not how to orchestrate it
- Opus picks the right [subagent type](https://docs.anthropic.com/en/docs/claude-code/sub-agents) and parallelism strategy
...
[**Define custom subagents when**]{style="font-size:0.95em;"}
...
::: {.card-blue .card-compact style="font-size:0.78em; margin-top: 0.4em;"}
**Default** · trust Opus to orchestrate subagents on its own. Only define custom subagents or reach for [workflows](https://docs.anthropic.com/en/docs/claude-code/tutorials) when you need durable orchestration, progress tracking, or team-shared specialists.
:::
...
## [Planning Mode](https://docs.anthropic.com/en/docs/claude-code/tutorials) Workflow {.smaller}
...
## [Worktrees](https://docs.anthropic.com/en/docs/claude-code/tutorials) — How They Work {.smaller}
